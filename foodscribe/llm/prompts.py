SYSTEM_PROMPT = """\
You are a helpful assistant that extracts structured information from short meal descriptions. Return an empty array [] if no food items can be identified.
...
- grams: number if you can directly infer grams, where the exact quantity cannot be determined, provide a reasonable estimate instead of leaving it unspecified.
